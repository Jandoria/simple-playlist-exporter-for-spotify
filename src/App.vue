<template>
  ...
  <section v-else id="profile">
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-4 p-4">
        ...
        <div class="flex flex-col">
          <strong class="text-slate-900 font-semibold dark:text-slate-200 flex">{{ userProfile.display_name }}</strong>
          <a
    ...
    <button v-if="!playlists.length" class="my-4" @click="getPlaylists">Get my playlists</button>
    <div v-if="playlists.length > 0" class="max-w-md border-y border-slate-500 divide-y divide-slate-500 divide-dashed my-6">
      <PlaylistCard
